...
const Registration = () => {
  const { singInUsingGoogle, singInUsingFacebook } = useAuth()
  const activeStyle = {
      ...
      <div className="form-container w-100% md:w-2/5 rounded-md overflow-hidden">
        ...
        <form className='p-5'>
          ...
          <div className='form-control flex items-center w-full h-12 rounded-md'>
            ...
            <input className='h-full px-4 border-none outline-none' type="text" placeholder='Image url' />
          </div>
          <div className='form-control flex items-center w-full h-12 rounded-md'>
            <div className='icon bg-text_primary h-full flex items-center justify-center'>
              <AiOutlineMail />
          ...
          <div className='form-control flex items-center w-full h-12 rounded-md'>
            ...
            <input className='h-full px-4 border-none outline-none' type="password" placeholder='Confirm password' />
          </div>
        ...
        <div className="other-login pb-4 lg:flex justify-center items-center gap-4">
          <button onClick={singInUsingGoogle} className='mx-auto lg:mx-0 mb-3 google w-2/3 lg:w-1/3 py-3 px-4 text-white rounded-full flex items-center gap-2 justify-center text-lg'><BsGoogle />Google</button>
          <button onClick={singInUsingFacebook} className='mx-auto lg:mx-0 mb-3 facebook w-2/3 lg:w-1/3 py-3 px-4 text-white rounded-full flex items-center gap-2 justify-center text-lg'><BsFacebook />Facebook</button>
        </div>
      </div>
    </div>
  );
