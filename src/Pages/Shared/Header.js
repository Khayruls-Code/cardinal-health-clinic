    ...
    <div className="header py-3 lg:py-0 shadow sticky top-0 w-full bg-white">
      <div className='container flex items-center justify-between'>
        ...
        <div className="header-btns">
          ...
          <NavLink className='px-6 py-2 hover:bg-secondary border-secondary ml-3 rounded-full hover:text-white font-medium transition-bg duration-500' to='/singup'>Sing Up</NavLink>
        </div>
